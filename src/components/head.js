...
import androidIcon from '@images/favicons/andriod-icon.png';
// import favicon32x32 from '@images/favicons/favicon-32x32.png';
import favicon96x96 from '@images/favicons/favicon-192x192.png';
// import favicon16x16 from '@images/favicons/favicon-16x16.png';
import msIcon512x512 from '@images/favicons/favicon-512x512.png';
...
const Head = ({ metadata }) => (
  <Helmet>
    ...
    <link rel="apple-touch-icon" sizes="60x60" href={appleIcon} />
    ...
    <link rel="apple-touch-icon" sizes="144x144" href={appleIcon} />
    <link rel="apple-touch-icon" sizes="152x152" href={appleIcon} />
    <link rel="apple-touch-icon" sizes="180x180" href={appleIcon} />
    <link rel="icon" type="image/png" sizes="192x192" href={androidIcon} />
    <link rel="icon" type="image/png" sizes="32x32" href={favicon96x96} />
    ...
    <meta name="msapplication-TileImage" content={msIcon512x512} />
